...
const translations = {
    en: {
        ...
        'thesis.s1': 'Item Control: Segment Semantic ID encodes 30s snapshots',
        'thesis.p2': '10min+ sessions need transition control',
        'thesis.s2': 'Timing Interface: Mid-stream transition optimization',
        'thesis.p3': 'Gifts/comments arrive in real-time',
        'thesis.s3': 'Feedback Interface: Real-time signal injection into decoding',
        'thesis.p4': 'Streamers need fair exposure to survive',
        'thesis.s4': 'Business Target: Cold-start fairness as first-class constraint',
    ...
    zh: {
        ...
        'thesis.solution': '解法',
        'thesis.p1': '内容逐秒变化',
        'thesis.s1': '物品控制：片段Semantic ID编码30秒快照',
        'thesis.p2': '10分钟+会话需要转场控制',
        'thesis.s2': '时序接口：直播间切换时机优化',
        'thesis.p3': '打赏/评论实时到达',
        'thesis.s3': '反馈接口：实时信号注入解码过程',
        'thesis.p4': '主播需要公平曝光才能存活',
        'thesis.s4': '业务目标：冷启动公平性作为一等约束',
        'thesis.metrics': '核心指标',
        'thesis.metric': '指标',
        'thesis.def': '定义',
        'thesis.role': '角色',
