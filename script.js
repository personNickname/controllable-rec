...
const translations = {
    en: {
        ...
        'mech.lat_1': 'Semantic IDs',
        'mech.lat_2': 'RQ-VAE Variants',
        'mech.lat_3': 'Context-Aware',
        'mech.lat_4': 'Cross-Modal',
        'mech.pref_desc': 'Aligning generation with preferences via DPO/RLHF.',
        'mech.pref_3': 'Reward Modeling',
        'mech.dec_desc': 'Steering output via PRM/ORM guidance during inference.',
        ...
        'mech.multi_1': 'Task Tokens — OneRanker, SIGMA',
        'mech.multi_2': 'Multi-Head — GPR, DRGrad, SMES',
        'mech.multi_3': 'Pareto — PreferRec, Deep Pareto RL, AutoCDSR',
        'mech.trade_1': 'Interest vs Value',
        'mech.trade_2': 'Diversity vs Relevance',
        'mech.trade_3': 'Short-term vs Long-term',
        'mech.trade_4': 'Accuracy vs Fairness',
        // Papers section
    ...
    zh: {
        ...
        'mech.pref_3': '奖励建模',
        'mech.dec_desc': '在推理时通过PRM/ORM引导来控制输出。',
        'mech.dec_1': '过程奖励',
        'mech.dec_2': '引导式Beam搜索',
        'mech.dec_3': '精细化评分',
        'mech.dec_4': '结果奖励',
        'mech.multi_desc': '通过任务令牌、独立头或帕累托优化平衡冲突目标。',
        'mech.multi_1': '任务令牌 — OneRanker, SIGMA',
        'mech.multi_2': '多头 — GPR, DRGrad, SMES',
        'mech.multi_3': '帕累托 — PreferRec, Deep Pareto RL, AutoCDSR',
        'mech.trade_1': '兴趣 vs 价值',
        'mech.trade_2': '多样性 vs 相关性',
        'mech.trade_3': '短期 vs 长期',
        'mech.trade_4': '准确性 vs 公平性',
        // Papers section
        'papers.title': '论文映射',
